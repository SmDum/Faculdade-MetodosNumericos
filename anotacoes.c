...
Polimônio Interpolador:
    ...
    p(x) = L0*f(x0) + L1*f(x1) + L2*f(x2)
    p(x) = L0*7.1338 + L1*9.1662 + L2*11.5545

    L(0) = ((X^2 - 1.33X + 0.429) / 0.159)
    L(1) = ((-X^2 + 1.03X - 0.195) / 0.069)
    L(2) = ((X^2 - 0.8X + 0.1375) / 0.1219)

    P(X) = (((X^2 - 1.33X + 0.429) / 0.159) * 7.1338) + (((-X^2 + 1.03X - 0.195) / 0.069) * 9.1662) + ((((X^2 - 0.8X + 0.1375) / 0.1219) * 11.5545))
